...
int main() {
  ...
  p_number4 = new int; 	// Dynamically allocate space for a single int on the
heap
                                                  // This memory belongs to our
program from now on. The system
                                                  // can't use it for anything
else, until we return it.
                                                  //After this line executes, we
will have a valid memory
                      // location allocated. The size of the allocated memory
will
                      // be such that it can store the type pointed to by the
                      // pointer
