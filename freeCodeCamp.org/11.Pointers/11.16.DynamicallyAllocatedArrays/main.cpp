...
int main() {
  ...
  double *p_scores{
      new (nothrow) double[size]{1, 2, 3, 4, 5}};  // Allocating memory space

  // nullptr check and use the allocated array
  if (p_scores) {
    cout << "size of scores (it's a regular pointer) : " << sizeof(p_scores)
         << endl;
  ...
  cout << "scores size : " << sizeof(scores) << endl;
  for (auto s : scores) {
    cout << "value : " << s << endl;
  }
  ...
  cout << "p_scores1 size : " << sizeof(p_scores1) << endl;
