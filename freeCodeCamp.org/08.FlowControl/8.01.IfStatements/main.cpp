...
int main() {
  ...
  if (result) cout << number1 << " is less than " << number2 << endl;

  if (!result) cout << number1 << " is NOT less than " << number2 << endl;
   ...
   */
  if (red) cout << "Stop" << endl;
  if (yellow) cout << "Slow down" << endl;
  if (green) cout << "GO" << endl;
