...
void use_options_v1(unsigned char flags) {
  cout << "bit0 is " << ((flags & mask_bit_0) >> 0) << ", do something with it!"
       << endl;
  cout << "bit1 is " << ((flags & mask_bit_1) >> 1) << ", do something with it!"
       << endl;
  cout << "bit2 is " << ((flags & mask_bit_2) >> 2) << ", do something with it!"
       << endl;
  cout << "bit3 is " << ((flags & mask_bit_3) >> 3) << ", do something with it!"
       << endl;
  cout << "bit4 is " << ((flags & mask_bit_4) >> 4) << ", do something with it!"
       << endl;
  cout << "bit5 is " << ((flags & mask_bit_5) >> 5) << ", do something with it!"
       << endl;
  cout << "bit6 is " << ((flags & mask_bit_6) >> 6) << ", do something with it!"
       << endl;
  cout << "bit7 is " << ((flags & mask_bit_7) >> 7) << ", do something with it!"
       << endl;
}
