...
int main()
{
    ...
    cout << "std::strncmp (" << string_data5 << "," << string_data6 << "," << n << ") : " << strncmp(string_data5,string_data6,n) << endl;
    ...
    cout << "std::strncmp (" << string_data5 << "," << string_data4 << "," << n << ") : " << strncmp(string_data5,string_data4,n) << endl;
