...
int main() {
  ...
  // str ); Replace the range [pos, pos + count] with str
  ...
  char txt4[15]{};  // Initialized with zero equivalent for characters which is
                    // '\0'
  cout << "srt4 : " << str4 << endl;
  ...
  string str_b{
      "This is a string stored in B and it's really great to be able to do "
      "that."};
