...
int solution(vector<string> &E) {
    ...
    for(vector<vector<int>>::iterator it = days.begin(); it != days.end(); it++){
        if(size <= (*it).size()){
    ...
    i = 0;
    days.clear();
    days = {vector<int>(), vector<int>(), vector<int>(), vector<int>(), vector<int>(), vector<int>(), vector<int>(), vector<int>(), vector<int>(), vector<int>()};
